...
execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_boots",Slot:100b}]}] run scoreboard players add @s bonus_insulation_warm 1
execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_boots",Slot:100b}]}] run scoreboard players remove @s bonus_insulation_cold 5

execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_leggings",Slot:101b}]}] run scoreboard players add @s bonus_insulation_warm 1
execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_leggings",Slot:101b}]}] run scoreboard players remove @s bonus_insulation_cold 5

execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_chestplate",Slot:102b}]}] run scoreboard players add @s bonus_insulation_warm 1
execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_chestplate",Slot:102b}]}] run scoreboard players remove @s bonus_insulation_cold 5

execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_helmet",Slot:103b}]}] run scoreboard players add @s bonus_insulation_warm 1
execute if entity @p[nbt={Inventory:[{id:"minecraft:iron_helmet",Slot:103b}]}] run scoreboard players remove @s bonus_insulation_cold 5
...
execute if score @s temp_penalty_warm matches 0 run tag @s remove   
execute if score @s temp_penalty_warm matches 0 run tag @s remove t_db_w2
